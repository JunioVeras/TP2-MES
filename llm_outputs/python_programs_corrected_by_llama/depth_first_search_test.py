...
def main():
    ...
    def add_successor(parent, child):
        parent.successors.append(child)

    add_successor(None, station1)
    add_successor(station1, station2)
    add_successor(station1, station3)
    add_successor(station2, station4)
    add_successor(station2, station3)
    add_successor(station3, station5)
    add_successor(station3, station4)
